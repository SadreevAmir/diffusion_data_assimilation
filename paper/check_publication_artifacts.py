...
REQUIRED_FILES = (
    ...
    "probabilistic_da_contract_oracle.py",
    "test_probabilistic_da_contract_oracle.py",
    "probabilistic_da_adapter_parity.py",
    "test_probabilistic_da_adapter_parity.py",
    ...
    "test_raw_member_reweighting_runner.py",
    ...
    "test_validate_casewise_safety_selector_compact_outputs.py",
    ...
    "validate_casewise_safety_selector_admission.py",
    "test_validate_casewise_safety_selector_admission.py",
    ...
    "rank_coherent_publication_renderer.py",
    "test_rank_coherent_publication_renderer.py",
    "score_aware_raw_reweighting_reference.py",
    "test_score_aware_raw_reweighting_reference.py",
    "score_aware_raw_reweighting_runner.py",
    "test_score_aware_raw_reweighting_runner.py",
    "score_aware_raw_reweighting_server_adapter.py",
    "test_score_aware_raw_reweighting_server_adapter.py",
