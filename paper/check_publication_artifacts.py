...
NEXT_GENERATIVE_METHOD_ANCHORS = {
    ...
    "REPRODUCIBILITY.md": (
        ...
        "(0.875,0.125)",
        "(1.0,0.0)",
        "exactly two members per pair",
        "source_experiment=joint_full_condition_validation_2022",
        "python3 paper/guidance_mixture_reference.py",
        "guidance-mixture reference checks: PASS",
        "compact_operational_accounting",
        "compact_run_accounting",
        "validate_runner_interface",
        "nonzero reported fallback count",
        "validate_compact_gate",
