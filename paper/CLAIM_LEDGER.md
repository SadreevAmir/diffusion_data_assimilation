...
| C20 | Cross-fitted global anomaly scaling is the selected calibrated-ensemble method. | Rejected by the joint stop/go rule | Proper scores improve, but boundary and spatial/physical mandatory families fail on all 40 completed cases | Retain it as a reproducible underdispersion correction and negative calibration baseline; do not call it broadly calibrated. |
