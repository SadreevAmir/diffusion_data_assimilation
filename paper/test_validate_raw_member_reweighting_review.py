    ...
    def test_combined_admission_returns_only_bound_literal_mode(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            record_path.write_text(
                json.dumps(valid_record(REFERENCE, synthetic), sort_keys=True),
                encoding="utf-8",
            )
            self.assertEqual(
