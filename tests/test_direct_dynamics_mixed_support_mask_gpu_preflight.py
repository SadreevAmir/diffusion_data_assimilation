...
def test_wrapper_enforces_single_gpu_policy_and_exact_commit():
    ...
    assert 'CONFIG="config/admission/direct_dynamics_mixed_support_train2016_2020_v2.json"' in source
    assert "direct_dynamics_mixed_support_v1.json" not in source
